...
services:
    ...
    mysql: 
        ...
        environment: 
            ...
            MYSQL_DATABASE: mon_premier_projets
        volumes: 
    ...
    adminer:
        ...
        labels:
            ...
            - "traefik.http.routers.adminer.rule=Host(`adminer.mon_premier_projets.localhost`)"  
    ...
    php:
        ...
        labels:
            ...
            - "traefik.http.routers.php.rule=Host(`php.mon_premier_projets.localhost`)"
